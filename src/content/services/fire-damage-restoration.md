...
priority: 9.0
plan_hash: "91ab4f1301c0dacc"
generated_at: "2026-07-26T06:53:34.047245+00:00"
manual_override: false
internal_links: ["/services/", "/contact/", "/service-areas/brandon-sd/fire-damage-restoration/", "/service-areas/brookings-sd/fire-damage-restoration/", "/service-areas/canton-sd/fire-damage-restoration/", "/service-areas/dell-rapids-sd/fire-damage-restoration/", "/service-areas/flandreau-sd/fire-damage-restoration/", "/service-areas/harrisburg-sd/fire-damage-restoration/", "/service-areas/hartford-sd/fire-damage-restoration/", "/service-areas/le-mars-ia/fire-damage-restoration/", "/service-areas/lennox-sd/fire-damage-restoration/", "/service-areas/luverne-mn/fire-damage-restoration/", "/service-areas/madison-sd/fire-damage-restoration/", "/service-areas/north-sioux-city-sd/fire-damage-restoration/", "/blog/choosing-a-restoration-company/", "/blog/fire-damage-restoration-process/", "/blog/smoke-odor-removal-techniques/"]
breadcrumb: [{"name": "Home", "url": "/"}, {"name": "Services", "url": "/services/"}, {"name": "Fire Damage Restoration"}]
faq: [{"question": "What's the difference between protein soot and synthetic soot, and why does the cleanup method change?", "answer": "Protein soot comes from burning organic material like food or grease \u2014 it's nearly invisible, leaves almost no visible residue, but produces an intense, persistent odor and a thin varnish-like film that bonds tightly to surfaces. Synthetic soot from burning plastics, foam, or rubber is dark, oily, and smears aggressively when wiped with the wrong technique, embedding deeper into drywall and porous materials. Each type requires a different cleaning chemistry and application method \u2014 using a dry-sponge approach on wet synthetic soot, for example, spreads contamination rather than removing it. Identifying soot type before touching a surface is one of the most important steps in preventing permanent staining."}, {"question": "How far does smoke actually travel in a house after a fire?", "answer": "Smoke follows air pressure and temperature differentials, which means it moves through wall cavities, HVAC ductwork, plumbing chases, and attic spaces \u2014 often reaching rooms with no visible fire damage within minutes of ignition. In homes with forced-air heating systems, the duct network can distribute smoke odor compounds throughout the entire structure before the system is shut off. This is why a kitchen fire can leave detectable odor in upstairs bedrooms and closets, and why a thorough restoration scope includes HVAC inspection and cleaning, not just the rooms with visible soot."}, {"question": "Does homeowners insurance cover fire damage restoration?", "answer": "Yes \u2014 accidental fire damage is one of the most commonly covered perils in a standard homeowners policy, and coverage typically includes structural cleaning, smoke and soot remediation, contents pack-out, deodorization, and reconstruction to pre-loss condition. Crew Restoration & Construction works with all insurance carriers and handles the claim documentation \u2014 photographs, moisture readings, itemized scope, and contents inventory \u2014 so the adjuster has everything needed to process the loss accurately. Your deductible and coverage limits will affect your out-of-pocket cost, so pulling your declarations page early helps set expectations."}, {"question": "Why does smoke odor sometimes come back months after a fire was \"cleaned\"?", "answer": "Odor rebound almost always traces back to one of three sources: HVAC ductwork that was never cleaned and re-deposits smoke compounds every time the system runs, drywall or subfloor that was painted or sealed over without proper odor-blocking primer, or porous structural materials \u2014 insulation, OSB sheathing, framing lumber \u2014 that weren't addressed because they weren't visibly charred. Smoke odor molecules are microscopic and penetrate well beyond the surface layer. Effective deodorization requires thermal fogging or ozone treatment to reach the same cavities the smoke originally traveled through, not just surface cleaning of visible areas."}, {"question": "What should I do \u2014 and avoid \u2014 in the hours immediately after a fire while waiting for restoration crews?", "answer": "The most important thing is to avoid wiping or washing soot-covered surfaces yourself \u2014 wet soot in particular smears and bonds permanently when disturbed with the wrong materials, turning a cleanable surface into one that requires replacement. Don't run the HVAC system, as this circulates smoke particles to unaffected areas. Ventilate if it's safe to do so by opening windows, and keep foot traffic through damaged areas to a minimum to avoid grinding soot into flooring. Document everything with your phone camera before anything is moved or touched \u2014 that visual record supports your insurance claim and helps the restoration team establish a pre-cleaning baseline."}]
...
|---|---|
| Single-room fire, limited soot, no reconstruction | $3,000 – $8,000 |
| Kitchen fire with grease soot, cabinet damage | $8,000 – $20,000 |
| Whole-house smoke infiltration, contents pack-out | $15,000 – $40,000 |
