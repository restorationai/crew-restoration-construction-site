...
title: "Board-Up and Tarping in Sioux Falls | Crew Restoration & Construction"
h1: "Board-Up and Tarping in Sioux Falls"
meta_description: "Board-up and tarping in Sioux Falls and surrounding areas. Insurance billing accepted. Call (605) 965-2727."
primary_keyword: "emergency board-up and tarping sioux falls"
secondary_keywords: ["roof tarping", "fire damage board up", "broken window board up"]
search_intent: "local_emergency"
priority: 6.3
plan_hash: "0e068f7fdee9832d"
generated_at: "2026-07-26T16:12:22.325218+00:00"
manual_override: false
internal_links: ["/services/", "/contact/", "/service-areas/adrian-mn/emergency-board-up-tarping/", "/service-areas/akron-ia/emergency-board-up-tarping/", "/service-areas/alton-ia/emergency-board-up-tarping/", "/service-areas/baltic-sd/emergency-board-up-tarping/", "/service-areas/beresford-sd/emergency-board-up-tarping/", "/service-areas/brandon-sd/emergency-board-up-tarping/", "/service-areas/brookings-sd/emergency-board-up-tarping/", "/service-areas/canton-sd/emergency-board-up-tarping/", "/service-areas/crooks-sd/emergency-board-up-tarping/", "/service-areas/dakota-dunes-sd/emergency-board-up-tarping/", "/service-areas/dell-rapids-sd/emergency-board-up-tarping/", "/service-areas/edgerton-mn/emergency-board-up-tarping/"]
breadcrumb: [{"name": "Home", "url": "/"}, {"name": "Services", "url": "/services/"}, {"name": "Emergency Board-Up and Tarping"}]
faq: [{"question": "Does homeowners insurance cover emergency board-up and tarping?", "answer": "Yes \u2014 in most policies, emergency board-up and tarping is covered under the duty-to-mitigate provision attached to the underlying covered peril (fire, wind, hail, vandalism). Crew Restoration & Construction works with all insurance carriers and handles the claim documentation, including pre- and post-coverage photos and a written scope of work, so your adjuster has everything needed to process the line item without delays."}, {"question": "What size tarp material is actually appropriate for a roof opening in South Dakota weather?", "answer": "For anything expected to last more than 48 hours \u2014 which is almost every situation in this climate \u2014 6-mil polyethylene is the practical minimum, and heavier woven poly tarps are preferable for larger sections or any opening that will stay covered through a wind event. The tarp also needs to be mechanically fastened with lumber battens screwed into the decking at close intervals; tarps held down by weight alone routinely fail in winds above 30\u201340 mph, which is a common condition here from spring through fall."}, {"question": "How long will a board-up or tarp hold before a permanent repair is needed?", "answer": "A properly installed tarp and board-up is a temporary measure, not a permanent fix. In South Dakota conditions, a well-fastened roof tarp can reliably protect a structure for two to six weeks, but UV degradation and wind fatigue reduce that window quickly. The goal is to stabilize the structure long enough for an insurance adjuster to inspect and for a permanent repair contractor to be scheduled \u2014 not to serve as a long-term solution."}, {"question": "For a fire-damaged home, does the order of board-up versus ventilation matter?", "answer": "It does. Boarding up a fire-damaged structure before it has been adequately ventilated traps smoke-laden air and soot particles inside, which accelerates odor penetration into porous materials like drywall, insulation, and wood framing. The correct sequence is to ventilate the structure first to clear combustion gases and reduce airborne soot concentration, then seal the openings. Skipping ventilation before board-up is one of the more common mistakes that leads to odor problems that persist long after structural repairs are complete."}, {"question": "What should I do to protect my property while waiting for the board-up crew to arrive?", "answer": "If it is safe to do so, move valuables, documents, and electronics away from the breach and toward the interior of the structure. Do not attempt to cover a roof opening yourself from above \u2014 the structural integrity after a storm or fire event is unknown and the fall risk is real. If weather is actively entering, placing plastic sheeting or towels at the interior base of the opening can limit surface damage while you wait, but avoid blocking access to the opening itself, as the crew will need to document and measure it before covering."}]
...
| Multiple windows / doors (3–6 openings) | $400 – $1,200 |
| Roof tarp, small section (under 200 sq ft) | $300 – $700 |
| Roof tarp, large section (200–800 sq ft) | $700 – $2,000 |
