...
priority: 8.1
plan_hash: "3f546eb1722a0632"
generated_at: "2026-07-26T06:54:32.635699+00:00"
manual_override: false
internal_links: ["/services/", "/contact/", "/service-areas/brandon-sd/sewage-cleanup/", "/service-areas/brookings-sd/sewage-cleanup/", "/service-areas/canton-sd/sewage-cleanup/", "/service-areas/dell-rapids-sd/sewage-cleanup/", "/service-areas/flandreau-sd/sewage-cleanup/", "/service-areas/harrisburg-sd/sewage-cleanup/", "/service-areas/hartford-sd/sewage-cleanup/", "/service-areas/le-mars-ia/sewage-cleanup/", "/service-areas/lennox-sd/sewage-cleanup/", "/service-areas/luverne-mn/sewage-cleanup/", "/service-areas/madison-sd/sewage-cleanup/", "/service-areas/north-sioux-city-sd/sewage-cleanup/"]
breadcrumb: [{"name": "Home", "url": "/"}, {"name": "Services", "url": "/services/"}, {"name": "Sewage Cleanup and Sanitization"}]
faq: [{"question": "Does homeowners insurance cover sewage backup cleanup?", "answer": "It depends on your policy \u2014 standard homeowners insurance often excludes sewer backup unless you've added a sewer or water backup endorsement, so the first call after the cleanup call should be to your insurance agent to confirm your coverage. Crew Restoration & Construction works with all insurance carriers and handles the claim documentation on your behalf, including moisture logs, photo documentation of affected materials, and itemized scopes of work that adjusters need to process the claim."}, {"question": "Is sewage backup water the same as a regular flood or water leak?", "answer": "No \u2014 sewage backup is classified as Category 3 water, the highest contamination category in the restoration industry, because it contains bacteria, viruses, and parasites that pose a direct health risk. Clean water from a burst pipe is Category 1 and can often be dried in place; Category 3 water requires removal of all porous materials it contacted, antimicrobial treatment of remaining surfaces, and documented disposal of contaminated debris. Treating a sewage backup like a clean water loss is one of the most common and costly mistakes in this industry."}, {"question": "What should I do \u2014 and not do \u2014 while waiting for the cleanup crew to arrive?", "answer": "Stay out of the affected area if you can, and keep children and pets away from any standing sewage or contaminated surfaces. Turn off the HVAC system if it's pulling air through the affected space, since that can spread airborne contaminants to other parts of the home. Don't run water in the affected fixture or nearby drains, and don't attempt to clean up sewage with household products \u2014 bleach alone doesn't address the full spectrum of pathogens in Category 3 water and can create a false sense that the area is safe."}, {"question": "How do you know when drywall or flooring needs to come out versus when it can be dried and kept?", "answer": "Any porous material that had direct contact with Category 3 sewage water \u2014 drywall, insulation, carpet, carpet pad \u2014 is removed, not dried. This isn't a judgment call; it's the standard protocol because those materials cannot be reliably decontaminated once sewage has absorbed into them. Hard, non-porous surfaces like concrete block, ceramic tile, and metal framing can be sanitized and kept if they're structurally sound. The cut line on drywall is typically set several inches above the visible water line to account for wicking that isn't visible to the eye."}, {"question": "Why does my basement still smell like sewage after it looks clean and dry?", "answer": "Persistent odor after a sewage backup almost always means contaminated material was left behind \u2014 commonly inside wall cavities, under subfloor sheathing, in floor drain traps, or in the drain line itself. Odor molecules from sewage bind to porous surfaces and continue off-gassing long after visible moisture is gone. If a space was cleaned but the smell remains, the area needs to be re-inspected with moisture meters and a camera scope on the drain line before any reconstruction closes the walls back up."}]
...
**1. Containment and safety staging**
Before any equipment enters the loss area, the space is assessed for electrical hazards, structural compromise, and the extent of contamination. Affected zones are isolated from clean areas of the home using physical barriers to prevent cross-contamination. Crew members working in Category 3 environments use appropriate personal protective equipment throughout.

**2. Solid and liquid waste removal**
...
|---|---|
| Single bathroom, contained drain backup, hard floors | $1,500 – $3,500 |
| Basement drain backup, partial carpet and drywall affected | $3,000 – $6,500 |
| Finished basement, full sewage backup with contents | $6,000 – $12,000 |
...
Crew Restoration & Construction serves Sioux Falls and the surrounding region, including Brandon, Tea, Harrisburg, Dell Rapids, Baltic, and Crooks. The city-specific sewage cleanup pages for each community link back here for the full technical detail on how this work is done. If you're outside these areas, call (605) 965-2727 and we'll let you know if we can help.

If you're standing in a basement that smells like a sewer right now, the next step is simple: call (605) 965-2727 to speak with someone who can walk you through what to do before we arrive, what not to touch, and how to start the documentation your insurance company will need.
