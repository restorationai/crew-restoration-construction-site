...
priority: 7.0
plan_hash: "10f57bbb27a2041a"
generated_at: "2026-07-26T07:10:51.622853+00:00"
manual_override: false
internal_links: ["/services/water-damage-restoration/", "/service-areas/lennox-sd/", "/service-areas/lennox-sd/fire-damage-restoration/", "/service-areas/lennox-sd/mold-remediation/", "/service-areas/brandon-sd/water-damage-restoration/", "/service-areas/brookings-sd/water-damage-restoration/", "/contact/"]
breadcrumb: [{"name": "Home", "url": "/"}, {"name": "Service Areas", "url": "/service-areas/"}, {"name": "Lennox", "url": "/service-areas/lennox-sd/"}, {"name": "Water Damage Restoration"}]
faq: [{"question": "How quickly can Crew Restoration & Construction reach a water damage call in Lennox?", "answer": "Lennox is approximately 20 miles from our Sioux Falls base via SD-115, so we can typically reach most Lennox addresses within a reasonable drive time depending on traffic and time of day. Call (605) 965-2727 and we'll give you an honest arrival estimate when you reach us \u2014 we don't overcommit on times we can't guarantee."}, {"question": "Are older homes near Downtown Lennox harder to dry out after a water loss?", "answer": "They can be. Homes built before the 1980s in the Downtown Lennox area often have plaster-and-lath wall assemblies, older fiberglass batt insulation without vapor barriers, and subfloors made of solid lumber rather than engineered panels. Solid lumber and plaster both absorb and release moisture more slowly than modern materials, which can extend the drying timeline. We account for this during the initial moisture mapping so the drying plan is calibrated to the actual materials, not a generic estimate."}, {"question": "Does Lennox's freeze-thaw climate affect how water damage jobs are scoped?", "answer": "Yes, in a couple of ways. Pipe bursts from hard freezes are common in January and February, and the water released often travels further through wall cavities before it's noticed because the house is closed up tight. We also have to account for outdoor temperature and humidity when sizing dehumidification equipment \u2014 cold, dry winter air actually assists drying in some cases, but it changes the equipment configuration compared to a summer loss."}, {"question": "What does the structural drying process actually involve, and how long does it take in a typical Lennox home?", "answer": "Structural drying uses industrial dehumidifiers to pull moisture vapor out of the air and high-velocity air movers to accelerate evaporation from wet surfaces and cavities. In a typical single-family home in Lennox with a contained water loss \u2014 say, a burst supply line affecting one room \u2014 drying usually takes three to five days, though that window shifts based on how long the water was present before extraction, what materials are affected, and current weather conditions. We take daily moisture readings and don't pull equipment until the numbers confirm the structure is dry."}, {"question": "Will my homeowners insurance cover water damage to my Lennox property, and how does the claims process work?", "answer": "Most standard homeowners policies in South Dakota cover sudden and accidental water discharge \u2014 burst pipes, appliance failures, and similar events \u2014 but they typically exclude gradual leaks or flood water entering from outside. We document the loss thoroughly from the first day on-site, including photographs, moisture logs, and a written scope, which gives your adjuster what they need to process the claim accurately. If you're unsure about your coverage, we can walk through the documentation with you before you file."}]
area_slug: "lennox-sd"
...
## Our Water Damage Restoration Process in Lennox
...
**Clearance and documentation.** Before equipment is removed, final moisture readings confirm that all affected materials have returned to acceptable levels. That documentation matters for your insurance claim and for any future sale of the property.
