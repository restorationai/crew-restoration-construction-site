...
priority: 4.9
plan_hash: "77b579130eb9d4df"
generated_at: "2026-07-26T16:25:13.435938+00:00"
manual_override: false
internal_links: ["/services/emergency-board-up-tarping/", "/service-areas/flandreau-sd/", "/service-areas/flandreau-sd/fire-damage-restoration/", "/service-areas/flandreau-sd/mold-remediation/", "/service-areas/adrian-mn/emergency-board-up-tarping/", "/service-areas/akron-ia/emergency-board-up-tarping/", "/contact/"]
breadcrumb: [{"name": "Home", "url": "/"}, {"name": "Service Areas", "url": "/service-areas/"}, {"name": "Flandreau", "url": "/service-areas/flandreau-sd/"}, {"name": "Emergency Board-Up and Tarping"}]
faq: [{"question": "How long does it typically take Crew Restoration & Construction to reach a property in Downtown Flandreau after a call?", "answer": "From our Sioux Falls base, the drive to Downtown Flandreau via SD-34 East is roughly 40 miles under normal conditions. When you call (605) 965-2727, dispatch will give you a realistic arrival estimate based on current road and crew availability \u2014 winter ice events between Colman and Flandreau can extend that window, and we'll tell you upfront rather than promise a time we can't meet."}, {"question": "Are homes near the Big Sioux River area at higher risk for secondary damage if board-up is delayed?", "answer": "Yes \u2014 properties in the Big Sioux River corridor already experience elevated ambient humidity, which accelerates moisture intrusion through any unprotected opening. IICRC guidance notes that mold colonization can begin within 24 to 48 hours in consistently humid conditions. Getting a tarp or board-up in place quickly is especially critical for river-adjacent properties in Flandreau."}, {"question": "Does the age of Flandreau's older housing stock affect how board-up panels are installed?", "answer": "It does. Many homes in and around Downtown Flandreau were built with full-dimension lumber, meaning rough window openings are slightly larger than modern framing standards predict. We take field measurements on every opening rather than relying on standard sizing, and we fasten OSB panels into the structural framing \u2014 not just the siding \u2014 so they hold through the high-wind events common to this part of eastern South Dakota."}, {"question": "What tarp specifications do you use for roof tarping in Flandreau's storm conditions?", "answer": "We use reinforced polyethylene tarps designed for high-wind exposure, secured with batten boards at the ridge and eaves rather than sandbags, which shift during plains-style gusts. The tarp extends at least three feet past the damaged area on all sides to handle the horizontal rain that frequently accompanies Flandreau's spring and fall storm systems. Tarps are not a permanent fix, but installed correctly they protect the structure through multiple weather cycles while repairs are scheduled."}, {"question": "Will my South Dakota homeowners' insurance cover emergency board-up and tarping costs after a fire or storm in the 57028 area?", "answer": "Most South Dakota homeowners' policies include coverage for \"reasonable repairs\" made to prevent further damage after a covered loss \u2014 which typically encompasses board-up and tarping. The critical factor is documentation: insurers need photographs, a written scope, and material receipts showing the work was necessary and proportionate. We provide all of that in a format aligned with standard adjuster review, and we can communicate directly with your carrier to help move the claim forward."}]
