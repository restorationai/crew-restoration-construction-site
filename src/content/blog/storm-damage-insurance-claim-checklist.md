...
generated_at: "2026-07-26T07:40:18.440305+00:00"
...
faq: [{"question": "How long do I have to file a storm damage insurance claim in South Dakota?", "answer": "Most homeowner policies in South Dakota require you to report a loss \"promptly\" or within a specific window \u2014 commonly one year from the date of loss, though some policies are shorter. Check your declarations page for the exact language. Filing sooner is always better: evidence is fresher, contractor availability is higher, and you avoid any argument that delayed reporting worsened the damage."}, {"question": "What's the difference between replacement cost value (RCV) and actual cash value (ACV) coverage?", "answer": "With replacement cost value coverage, your insurer pays what it costs to replace the damaged item or material at today's prices. With actual cash value coverage, they subtract depreciation \u2014 so a 15-year-old roof with a 20-year lifespan might only pay out 25% of replacement cost. Many policies pay ACV upfront and release the depreciation holdback once repairs are completed and you submit proof. Knowing which type you have before you call changes how you evaluate the adjuster's offer."}, {"question": "Can I get my own contractor estimate before the insurance adjuster visits?", "answer": "Yes, and it's often a good idea. Having a written estimate from a licensed local contractor gives you a baseline to compare against the adjuster's scope of loss. If the adjuster's estimate is significantly lower, your contractor's documentation \u2014 including photos, measurements, and material costs \u2014 can support a supplemental claim or a re-inspection request. Just make sure no permanent repairs are made before the adjuster has seen the damage."}, {"question": "What if the storm damage caused a slow leak I didn't notice for weeks?", "answer": "This is where claims get complicated. Insurers cover sudden and accidental losses, but they may dispute damage they classify as resulting from long-term neglect or a pre-existing condition. Your best defense is documentation showing the storm was the originating cause \u2014 weather records for your zip code, photos of the breach point, and a moisture report from a restoration professional that establishes the timeline of water intrusion. A contractor who can write a causation narrative tied to the storm date is valuable in these situations."}]
...
Insurance adjusters work from evidence. The more you have, the harder it is for a claim to be disputed or reduced. Your phone camera is your most important tool right now.
...
- A written description of what you observed when you first entered the property.
...
This is the actual checklist. Go through it line by line before you call your insurer.

**Documentation:**
- [ ] Photos and video of all exterior damage
- [ ] Photos and video of all interior damage
- [ ] Written timeline of the storm and your discovery of damage
- [ ] List of damaged personal property with estimated values
- [ ] Serial/model numbers for damaged appliances and electronics
- [ ] Receipts or bank statements showing purchase of high-value items (if available)
...
- [ ] Claim number once assigned
- [ ] Date, time, and summary of every call or email with your insurer
