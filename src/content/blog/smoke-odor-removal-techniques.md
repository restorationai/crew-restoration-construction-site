...
generated_at: "2026-07-26T07:45:52.464030+00:00"
...
faq: [{"question": "How long does smoke odor last if it isn't professionally treated?", "answer": "It depends on the severity of the smoke exposure and the materials affected. Light smoke from a single incident in a well-ventilated space may fade within a few days. Residue that has penetrated porous materials \u2014 drywall, insulation, wood framing, carpet padding \u2014 can off-gas for months or even years, especially in warm weather when heat causes the absorbed compounds to re-volatilize. Without treatment that addresses the source material, the smell typically cycles rather than disappears."}, {"question": "Is smoke odor dangerous, or is it just unpleasant?", "answer": "Smoke residue contains fine particulates and volatile organic compounds (VOCs) that can irritate the respiratory tract, trigger asthma, and cause headaches and eye irritation with prolonged exposure. People with pre-existing respiratory conditions, young children, and elderly individuals are most vulnerable. The odor itself is a symptom of ongoing off-gassing \u2014 meaning if you can smell it, you're inhaling the compounds causing it. This isn't intended as medical advice, but it's a reasonable basis for taking persistent smoke odor seriously rather than waiting it out."}, {"question": "Can I use an ozone machine I rented from a hardware store?", "answer": "Consumer ozone machines are generally underpowered for significant smoke contamination \u2014 they may reduce surface odor temporarily without reaching the concentration needed to break down compounds in porous materials. More importantly, ozone at effective concentrations is harmful to people, pets, and plants, and requires the space to be completely vacated and properly ventilated before re-entry. Improper use is a genuine health risk. Professional-grade ozone treatment uses calibrated equipment with controlled exposure times and post-treatment air testing to confirm safe re-entry levels."}, {"question": "Will my homeowner's insurance cover smoke odor remediation?", "answer": "In most cases, yes \u2014 if the smoke resulted from a covered peril such as a fire in your home or an adjacent structure. Standard homeowner's policies typically cover smoke damage remediation, including odor treatment, as part of the overall fire or smoke loss. The key is proper documentation: photos, moisture and air quality readings, and an itemized scope of work. A restoration company familiar with insurance claims can prepare that documentation in a format your adjuster can process, which usually speeds up the approval timeline."}]
...
- **Ozone machines rented from a hardware store**: Ozone does break down odor molecules, but consumer-grade units don't generate sufficient concentration for heavily contaminated spaces, and improper use is a health hazard. Ozone at effective concentrations is harmful to lungs and must not be used in occupied spaces or around pets and plants.
- **Repainting walls**: Latex paint is not an odor barrier. Smoke compounds will migrate through standard latex within weeks. Shellac-based primer (like Zinsser BIN) can encapsulate odors on hard surfaces, but it doesn't address what's inside the wall cavity or in the flooring.
- **Washing everything**: Useful for clothing and soft goods, but surface washing alone won't reach the smoke that has penetrated into the structure of the building.

The pattern in all of these: they address the symptom (the smell you can detect right now) without addressing the source (the compounds bonded to materials throughout the structure).
